...
[![Maven Central](https://img.shields.io/maven-central/v/com.dataliquid.maven/json-yaml-validator-maven-plugin.svg)](https://search.maven.org/artifact/com.dataliquid.maven/json-yaml-validator-maven-plugin)
